...
let userName;
if (Name) {
    userName = encodeURIComponent(Name.toLowerCase().split(" ").join("-"));
}
else {
    userName = "user";
}
let base_url = "http://127.0.0.1:5500/Inner%20Page/index.html";
let url = `${base_url}?/${userName}`;
share_btn.addEventListener("click", () => {
    anc === null || anc === void 0 ? void 0 : anc.setAttribute("href", url);
    // LINK COPY
